...
public final class ParseDataHelper {
	 ...
	 *
	 * @param field
	 *            The value of the field to be checked
	 ...
	 *            value of the field
	 * @param e
	 *            Exception raised due to invalid format
	 * @throws DataValidationException
	 */
     ...
     * @param fieldValue value of the field
     * @param errDesc Description message of error
     * @throws DataValidationException
     */
    public static void raiseInvalidDataException(String fieldName,
            String fieldValue, String errDesc) throws DataValidationException {
        String errMessage = String.format(
                DataValidationException.INVALID_FORMAT_MESSAGE, fieldName,
                fieldValue);
        throw new DataValidationException(errMessage,
