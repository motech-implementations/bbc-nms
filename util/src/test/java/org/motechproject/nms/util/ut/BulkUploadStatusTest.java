...
public class BulkUploadStatusTest {
    ...
    /**
     * Test class to test that logFileName, bulkUploadFileName,
     * logFileServerIP, numberOfFailedRecords, numberOfSuccessfulRecords
     * are correctly being set in the BulkUploadStatus object.
     */
     @Test
