...
public class MobileAcademyConstants {
    ...
    public static final String COURSE_CSV_UPLOAD_SUCCESS_EVENT = "mds.crud.mobileacademy.CourseRawContent.csv-import.success";

    public static final String COURSE_CSV_UPLOAD_FAILURE_EVENT = "mds.crud.mobileacademy.CourseRawContent.csv-import.failure";
    ...
    public static final String INSUFFICIENT_RECORDS_FOR_MODIFY = "Insufficient Records for modifying the file name for Content Name: {}. Hence Aborting the Modification process for this content file name.";

    public static final String INCONSISTENT_RECORD_FOR_MODIFY = "Inconsistent Record for modifying the file name for Content Name: {}. Hence Aborting the Modification process for this content file name.";

    public static final String INSUFFICIENT_RECORDS_FOR_ADD = "Insufficient Records for adding the course for Language Location Code: {}. Hence Aborting the Course Addition process for this Language location code.";

    public static final String INCONSISTENT_RECORDS_FOR_ADD = "Inconsistent Record for adding the course for Language Location Code: {}. Hence Aborting the Course Addition process for this Language location code.";

    public static final String INSUFFICIENT_RECORDS_FOR_DEL = "Insufficient Records for deleting the course for Language Location Code: {}. Hence Aborting the Course Deletion process for this Language location code.";
