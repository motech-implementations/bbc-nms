...
public class BookmarkHelper {
     ...
     * 
     * @param courseBookmark : MTraining bookmark to be populated
     * @param bookmarkID : bookmark node id as mentioned in course structure
     * @param scoresByChapter : user's score in different chapters
    ...
    private static void validateAndPopulateScoresInBookmark(
        ...
        List<String> chapterKeys = new ArrayList<String>(
                scoresByChapter.keySet());
