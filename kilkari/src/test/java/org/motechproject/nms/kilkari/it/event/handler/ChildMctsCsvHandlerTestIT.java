...
public class ChildMctsCsvHandlerTestIT extends CommonStructure {
    ...
    public void testScheduledSubscriptionApi(){
        ...
        logger.info("Inside testScheduledSubscriptionApi");
        ...
        csv.setIdNo("13");
        csv.setBirthdate("2015-04-15 08:08:08");
        ChildMctsCsv dbCsv = childMctsCsvDataService.create(csv);
        uploadedIds.add(dbCsv.getId());
        callChildMctsCsvHandlerSuccessEvent(uploadedIds); // Created New Record
        uploadedIds.clear();
        
        csv = new ChildMctsCsv();
        csv = createChildMcts(csv);
        csv.setWhomPhoneNo("1000000014");
        csv.setIdNo("14");
        csv.setBirthdate("2014-01-02 08:08:08");
        dbCsv = childMctsCsvDataService.create(csv);
        uploadedIds.add(dbCsv.getId());
        callChildMctsCsvHandlerSuccessEvent(uploadedIds); // Created New Record
        uploadedIds.clear();
        ...
        csv.setIdNo("15");
        csv.setBirthdate("2014-01-03 08:08:08");
        dbCsv = childMctsCsvDataService.create(csv);
        uploadedIds.add(dbCsv.getId());
        callChildMctsCsvHandlerSuccessEvent(uploadedIds); // Created New Record
        uploadedIds.clear();
        ...
        csv.setIdNo("16");
        csv.setBirthdate("2014-01-04 08:08:08");
        dbCsv = childMctsCsvDataService.create(csv);
        uploadedIds.add(dbCsv.getId());
        callChildMctsCsvHandlerSuccessEvent(uploadedIds); // Created New Record
        uploadedIds.clear();
        ...
        csv.setIdNo("17");
        csv.setBirthdate("2014-01-05 08:08:08");
        dbCsv = childMctsCsvDataService.create(csv);
        uploadedIds.add(dbCsv.getId());
        callChildMctsCsvHandlerSuccessEvent(uploadedIds); // Created New Record
        uploadedIds.clear();
        ...
        csv.setIdNo("18");
        csv.setBirthdate("2014-01-06 08:08:08");
        dbCsv = childMctsCsvDataService.create(csv);
        uploadedIds.add(dbCsv.getId());
        callChildMctsCsvHandlerSuccessEvent(uploadedIds); // Created New Record
        uploadedIds.clear();
        ...
        csv.setIdNo("19");
        csv.setBirthdate("2014-01-07 08:08:08");
        dbCsv = childMctsCsvDataService.create(csv);
        uploadedIds.add(dbCsv.getId());
        callChildMctsCsvHandlerSuccessEvent(uploadedIds); // Created New Record
        uploadedIds.clear();
        ...
        csv.setIdNo("20");
        csv.setBirthdate("2014-01-08 08:08:08");
        dbCsv = childMctsCsvDataService.create(csv);
        uploadedIds.add(dbCsv.getId());
        callChildMctsCsvHandlerSuccessEvent(uploadedIds); // Created New Record
        uploadedIds.clear();
        ...
        csv.setIdNo("21");
        csv.setBirthdate("2014-01-09 08:08:08");
        dbCsv = childMctsCsvDataService.create(csv);
        uploadedIds.add(dbCsv.getId());
        callChildMctsCsvHandlerSuccessEvent(uploadedIds); // Created New Record
        uploadedIds.clear();
        ...
        csv.setIdNo("22");
        csv.setBirthdate("2014-01-10 08:08:08");
        dbCsv = childMctsCsvDataService.create(csv);
        uploadedIds.add(dbCsv.getId());
        callChildMctsCsvHandlerSuccessEvent(uploadedIds); // Created New Record
        uploadedIds.clear();
        ...
        csv.setIdNo("23");
        csv.setBirthdate("2014-01-11 08:08:08");
        dbCsv = childMctsCsvDataService.create(csv);
        uploadedIds.add(dbCsv.getId());
        callChildMctsCsvHandlerSuccessEvent(uploadedIds); // Created New Record
        uploadedIds.clear();
        ...
        csv = new ChildMctsCsv();
        csv = createChildMcts(csv);
        csv.setWhomPhoneNo("1000000024");
        csv.setIdNo("24");
        csv.setBirthdate("2014-01-12 08:08:08");
        dbCsv = childMctsCsvDataService.create(csv);
        uploadedIds.add(dbCsv.getId());
        callChildMctsCsvHandlerSuccessEvent(uploadedIds); // Created New Record
        uploadedIds.clear();
        ...
        csv = new ChildMctsCsv();
        csv = createChildMcts(csv);
        csv.setWhomPhoneNo("1000000025");
        csv.setIdNo("25");
        csv.setBirthdate("2014-01-13 08:08:08");
        dbCsv = childMctsCsvDataService.create(csv);
        uploadedIds.add(dbCsv.getId());
        callMotherMctsCsvHandlerSuccessEvent(uploadedIds); // Created New Record
        uploadedIds.clear();
