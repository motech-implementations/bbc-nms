...
import org.motechproject.nms.kilkari.it.event.handler.ChildMctsCsvHandlerTestIT;
import org.motechproject.nms.kilkari.it.event.handler.ContentUploadCsvHandlerIT;
import org.motechproject.nms.kilkari.it.event.handler.MotherMctsCsvHandlerIT;
 ...
 */
@RunWith(Suite.class)
@Suite.SuiteClasses({ ChildMctsCsvHandlerTestIT.class,
        ContentUploadCsvHandlerIT.class, MotherMctsCsvHandlerIT.class,
